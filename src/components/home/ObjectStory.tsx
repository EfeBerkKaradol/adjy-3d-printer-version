...
import { STORY_ACTS, STORY_ASPECT, STORY_VIDEO, actIndexFor } from "./objectStoryTimeline";
    ...
    <div id="adjy-yontem">
      ...
      >
        <div className="sticky top-0 flex h-screen items-center overflow-hidden">
          <div className="adjy-container grid w-full grid-cols-1 items-center gap-8 md:grid-cols-[minmax(0,4fr)_minmax(0,6fr)] md:gap-12 lg:gap-16">
            {/* Metin ikinci sırada: ürünün üstünü hiçbir noktada
                kapatmaz, perdeler ürün hareket ederken akar. */}
            <div className="order-2 md:order-1">
              <p className="adjy-eyebrow mb-4">ADJY nedir</p>
              <motion.div
                key={current.n}
            ...
            {/* Çerçeve render'ın kendi oranında kurulur — görüntü
                hiçbir ekranda kırpılmaz, yüksekliği ekrana sığar. */}
            <div
              className="relative order-1 mx-auto h-[38vh] max-w-full overflow-hidden bg-surface-2 md:order-2 md:h-[74vh]"
              style={{ aspectRatio: STORY_ASPECT }}
            >
              {/* Video çözülene kadar görünen kare: ürünün gerçek fotoğrafı */}
